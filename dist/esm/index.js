...
const { toString: Ye } = Object.prototype, { getPrototypeOf: ae } = Object, J = ((e) => (t) => {
  const n = Ye.call(t);
  return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), A = (e) => (e = e.toLowerCase(), (t) => J(t) === e), V = (e) => (t) => typeof t === e, { isArray: F } = Array, U = V("undefined");
function et(e) {
...
const nt = V("string"), g = V("function"), Fe = V("number"), W = (e) => e !== null && typeof e == "object", rt = (e) => e === !0 || e === !1, j = (e) => {
  if (J(e) !== "object")
    return !1;
  const t = ae(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, st = A("Date"), ot = A("File"), it = A("Blob"), at = A("FileList"), ct = (e) => W(e) && g(e.pipe), ut = (e) => {
  let t;
  return e && (typeof FormData == "function" && e instanceof FormData || g(e.append) && ((t = J(e)) === "formdata" || t === "object" && g(e.toString) && e.toString() === "[object FormData]"));
...
const Be = (() => typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global)(), De = (e) => !U(e) && e !== Be;
function ee() {
  const { caseless: e } = De(this) && this || {}, t = {}, n = (r, s) => {
    const o = e && Le(t, s) || s;
    j(t[o]) && j(r) ? t[o] = ee(t[o], r) : j(r) ? t[o] = ee({}, r) : F(r) ? t[o] = r.slice() : t[o] = r;
  };
  for (let r = 0, s = arguments.length; r < s; r++)
    arguments[r] && k(arguments[r], n);
  return t;
}
const yt = (e, t, n, { allOwnKeys: r } = {}) => (k(t, (s, o) => {
  n && g(s) ? e[o] = Pe(s, n) : e[o] = s;
}, { allOwnKeys: r }), e), wt = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e), bt = (e, t, n, r) => {
  ...
  for (; t-- > 0; )
    n[t] = e[t];
  return n;
}, gt = ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && ae(Uint8Array)), Ot = (e, t) => {
  ...
  for (; (n = e.exec(t)) !== null; )
    r.push(n);
  return r;
}, At = A("HTMLFormElement"), xt = (e) => e.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, r, s) {
    return r.toUpperCase() + s;
  }
), ye = (({ hasOwnProperty: e }) => (t, n) => e.call(t, n))(Object.prototype), Ct = A("RegExp"), Ue = (e, t) => {
...
}, Ft = (e, t) => e != null && Number.isFinite(e = +e) ? e : t, X = "abcdefghijklmnopqrstuvwxyz", we = "0123456789", ke = {
  DIGIT: we,
  ALPHA: X,
...
const Dt = (e) => {
  ...
  return n(e, 0);
}, Ut = A("AsyncFunction"), kt = (e) => e && (W(e) || g(e)) && g(e.then) && g(e.catch), a = {
  isArray: F,
  isArrayBuffer: _e,
  isBuffer: et,
  isFormData: ut,
...
function K(e, t, n) {
  ...
  function u(d, m, R) {
    ...
    if (d && !R && typeof d == "object") {
      ...
      else if (a.isArray(d) && qt(d) || (a.isFileList(d) || a.endsWith(m, "[]")) && (S = a.toArray(d)))
        return m = He(m), S.forEach(function(w, B) {
          !(a.isUndefined(w) || w === null) && t.append(
            i === !0 ? be([m], B, o) : i === null ? m : m + "[]",
            l(w)
          );
        }), !1;
    }
    return te(d) ? !0 : (t.append(be(R, m, o), l(d)), !1);
  }
...
}, $t = typeof URLSearchParams < "u" ? URLSearchParams : ce, zt = typeof FormData < "u" ? FormData : null, Jt = typeof Blob < "u" ? Blob : null, Vt = {
  isBrowser: !0,
  classes: {
    URLSearchParams: $t,
    FormData: zt,
...
}, ue = typeof window < "u" && typeof document < "u", Wt = ((e) => ue && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(typeof navigator < "u" && navigator.product), Kt = (() => typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && typeof self.importScripts == "function")(), vt = ue && window.location.href || "http://localhost", Gt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: ue,
...
const T = v;
function Z(e, t) {
  const n = this || fe, r = t || n, s = T.from(r.headers);
  let o = r.data;
...
}, ln = O.hasStandardBrowserEnv ? function() {
...
const Ke = (e) => {
  ...
  t.headers = i = T.from(i), t.url = Me(We(t.baseURL, t.url), e.params, e.paramsSerializer), c && i.set(
    "Authorization",
  ...
  const s = function(f) {
    if (!r) {
      ...
      n.abort(l instanceof h ? l : new L(l instanceof Error ? l.message : l));
    }
  };
  let o = t && setTimeout(() => {
...
}, G = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", ve = G && typeof ReadableStream == "function", ne = G && (typeof TextEncoder == "function" ? ((e) => (t) => e.encode(t))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), Rn = ve && (() => {
  let e = !1;
...
G && ((e) => {
  ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((t) => {
    !M[t] && (M[t] = a.isFunction(e[t]) ? (n) => n[t]() : (n, r) => {
...
const Sn = async (e) => {
  ...
  let x;
  try {
    if (f && Rn && n !== "get" && n !== "head" && (x = await gn(u, r)) !== 0) {
      let C = new Request(t, {
        method: "POST",
        body: r,
        duplex: "half"
      }), _;
      a.isFormData(r) && (_ = C.headers.get("content-type")) && u.setContentType(_), C.body && (r = Oe(C.body, Ae, Te(
        x,
        I(f)
      ), null, ne));
    }
    ...
    let w = await fetch(R);
    const B = re && (l === "stream" || l === "response");
    if (re && (c || B)) {
      const C = {};
    ...
    l = l || "text";
    let Ze = await M[a.findKey(M, l) || "text"](w, e);
    return !B && S(), d && d(), await new Promise((C, _) => {
      Ve(C, _, {
        data: Ze,
...
const xe = (e) => `- ${e}`, Tn = (e) => a.isFunction(e) || e === null || e === !1, Ge = {
  getAdapter: (e) => {
    e = a.isArray(e) ? e : [e];
    const { length: t } = e;
    let n, r;
    ...
    for (let o = 0; o < t; o++) {
      n = e[o];
      let i;
      if (r = n, !Tn(n) && (r = se[(i = String(n)).toLowerCase()], r === void 0))
...
function Ce(e) {
  return Y(e), e.headers = T.from(e.headers), e.data = Z.call(
    e,
    e.transformRequest
  ), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), Ge.getAdapter(e.adapter || fe.adapter)(e).then(function(r) {
    ...
    return Je(r) || (Y(e), r && r.response && (r.response.data = Z.call(
      e,
      e.transformResponse,
      r.response
...
const Pn = ie;
function Qe(e) {
  const t = new H(e), n = Pe(H.prototype.request, t);
...
E.HttpStatusCode = Pn;
E.default = E;
const he = E, z = "https://api.internal.temp-mail.io", _n = async () => {
  const e = `${z}/api/v3/email/new`;
  return (await he.post(e)).data;
}, Fn = async (e) => {
  const t = `${z}/api/v3/email/${e}/messages`;
  return (await he.get(t)).data.map((o) => ({
    ...o,
    bodyText: o.body_text,
    bodyHtml: o.body_html,
    createdAt: new Date(o.created_at),
    attachments: o.attachments.map((i) => ({
      ...i,
      url: `${z}/api/v3/attachment/${i.id}?download=1`
    }))
  }));
}, Ln = async (e, t) => {
  const n = `${z}/api/v3/email/${e}`;
  await he.delete(n, { data: { token: t } });
};
export {
  Ln as deleteEmail,
  Fn as fetchEmails,
